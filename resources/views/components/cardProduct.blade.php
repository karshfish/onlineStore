...
<div class="product-card bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 cursor-pointer" 
     data-id="{{ $product['id'] }}"
    ...
    <div class="p-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors" onclick="event.stopPropagation()">
                Add to Cart
            </button>
        </div>
    </div>
